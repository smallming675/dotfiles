      ...
      return {
        {
          ...
          config = function()
            ...
            local servers = {
              "html", "cssls", "rust-analyzer", "clangd", "typescript-language-server",
              "gopls", "volar", "vscode-json-languageserver", 
  ...
  programs.direnv = {
   ...
   programs.opencode = {
     ...
     settings = {
       ...
       plugin = [ "cc-safety-net" "@tarquinen/opencode-dcp@latest" "micode" "@bastiangx/opencode-unmoji"];
       provider = {
         anthropic = {
           options = {
